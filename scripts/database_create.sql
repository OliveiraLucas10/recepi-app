...
create table recipe_category (recepi_id bigint not null, category_id bigint not null, primary key (recepi_id, category_id)) engine=InnoDB;
...
alter table recipe_category add constraint FK8haasd9kno1supm9uy253fikp foreign key (recepi_id) references recipe (id);